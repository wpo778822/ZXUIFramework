...
@protocol ZXTextViewDelegate <UITextViewDelegate>
 ...
 */
- (void)textView:(ZXTextView *)textView newHeightAfterTextChanged:(CGFloat)height;
 ...
 */
- (BOOL)textViewShouldReturn:(ZXTextView *)textView;
 ...
 */
- (void)textView:(ZXTextView *)textView didPreventTextChangeInRange:(NSRange)range replacementText:(NSString *)replacementText;
...
@property(nonatomic, weak) id<ZXTextViewDelegate> zxDelegate;
...
/**
 是否显示剩余字符 默认 NO
 */
@property(nonatomic, assign) BOOL showSurplusTextNumber;
